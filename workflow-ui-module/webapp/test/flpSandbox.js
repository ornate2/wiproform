		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#wiprofrmworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wiprofrmworkflowuimodule-display": {
								"semanticObject": "wiprofrmworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wiprofrm.workflowuimodule",
									"url": sap.ui.require.toUrl("wiprofrm/workflowuimodule")
								}
							}
						}
					}
